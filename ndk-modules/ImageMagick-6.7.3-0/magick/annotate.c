...
#  include </opt/X11/include/ft2build.h>
#endif
#if defined(FT_FREETYPE_H)
#  include </opt/X11/include/freetype2/freetype/freetype.h>
#else
#  include </opt/X11/include/freetype2/freetype/freetype.h>
#endif
#if defined(FT_GLYPH_H)
#  include </opt/X11/include/freetype2/freetype/ftglyph.h>
#else
#  include </opt/X11/include/freetype2/freetype/ftglyph.h>
#endif
#if defined(FT_OUTLINE_H)
#  include </opt/X11/include/freetype2/freetype/ftoutln.h>
#else
#  include </opt/X11/include/freetype2/freetype/ftoutln.h>
#endif
#if defined(FT_BBOX_H)
#  include </opt/X11/include/freetype2/freetype/ftbbox.h>
#else
#  include </opt/X11/include/freetype2/freetype/ftbbox.h>
